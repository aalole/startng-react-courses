...
const  PrivacyPolicy = ()=>{
    ...
    <div className="policyBody">
        <div className="policy-header-container  pb-5">
            <section className="policy-header-background">
                <div className="text-center heading-title policyPad-sm my-5" style={{margin: "90px 0"}}>
                    <p className="d-block up" style={{fontSize: "14px", color: "#E7332B", fontFamily: "Averta-Regular"}}>PRIVACY POLICY
                    </p>
                    <p>These terms and conditions outline the </p>
                     <p className="policy-title">rules for the use of start.ng website</p>   
                </div>
            </section>
        </div>
    ...
    <div className="policy mb-5">
        ...
        {/* PRIVACY POLICY FROM GETPRIVACY STARTS HERE */}
        <h3>PRIVACY POLICY</h3>
        <p>
            Your privacy is important to us. It is startNg's policy to respect
            your privacy regarding any information we may collect from you across
            our website, <a href="https://start.ng/">https://start.ng/</a>, and
        ...
        <p>This policy is effective as of 23 July 2020.</p>
        {/* <p><a href="https://getterms.io" title="Generate a free privacy policy">Privacy Policy created with GetTerms.</a></p> */}
        {/* PRIVACY POLICY FROM GETPRIVACY ENDS HERE  */}
        </div>
        <div className="policyPreface">
        {/* <TERMS AND CONDITIONS FROM GETPRIVACY.IO STARTS HERE */}
        <h2>Terms of Service</h2>
        <h3>1. Terms</h3>
        <p>
            By accessing the website at
            <a href="https://start.ng/"> https://start.ng/ </a>, you are agreeing to
        ...
        <h3>2. Use License</h3>
        <ol className="policyOrdered" type="a">
            <li>
            Permission is granted to temporarily download one copy of the
            materials (information or software) on startNg's website for
            personal, non-commercial transitory viewing only. This is the grant
            of a license, not a transfer of title, and under this license you
            may not:
            <ol className="policyOrdered" type="i">
            ...
            these restrictions and may be terminated by startNg at any time.
        ...
        <h3>4. Limitations</h3>
        <p>
            In no event shall startNg or its suppliers be liable for any damages
            (including, without limitation, damages for loss of data or profit, or
            due to business interruption) arising out of the use or inability to
            use the materials on startNg's website, even if startNg or a startNg
        ...
        <p>
            The materials appearing on startNg's website could include technical,
            typographical, or photographic errors. startNg does not warrant that
            any of the materials on its website are accurate, complete or current.
            startNg may make changes to the materials contained on its website at
            any time without notice. However startNg does not make any commitment
            to update the materials.
        </p>
        <h3>6. Links</h3>
        <p>
            startNg has not reviewed all of the sites linked to its website and is
            not responsible for the contents of any such linked site. The
            inclusion of any link does not imply endorsement by startNg of the
            site. Use of any such linked website is at the user's own risk.
        </p>
        <h3>7. Modifications</h3>
        <p>
            startNg may revise these terms of service for its website at any time
        ...
        {/* TERMS AND CONDITIONS FROM GETPRIVACY.IO ENDS HERE */}

        <h3>WHY STARTNG</h3>
        <p className="policy-pref-p-1">By accessing this website we assume you accept these terms and conditions in full. Do
            not continue to use
            start.ng's website if you do not accept all of the terms and conditions stated on this page. </p>
        {/* <p>The
            ...
            accepting the Company's terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers
            ...
            prevailing law of Nigeria. Any use of the above terminology or other words in the singular, plural,
        ...
        <h3>COOKIES</h3>
        <p className="policy-cooky-1">
            We employ the use of cookies. By using start.ng's website you consent
            to the use of cookies in accordance with start.ng's privacy policy.
        </p>
        <p>
        ...
        <div className="policyHyperlinks">
        <h3>HYPERLINKING TO OUR CONTENT</h3>
        <ol className="policyOrdered">
            <li>
            The following organizations may link to our Web site without prior
            written approval:
            </li>
            <ul className="policyUnordered">
            ...
            <ul className="policyUnordered">
            <li>Is not in any way misleading search engines;</li>
            <li>
                Does not falsely imply sponsorship, endorsement or approval of the
                linking party and its products or services;
            </li>
            <li>
                Lastly fits within the context of the linking party's site..
            </li>
            </ul>
            <li>
            These organizations may link to our home page, to publications or to
        ...
        <div className="policy-continue">
            ...
            hyperlink outweighs the absence of start.ng; and (d) where the link
            ...
            sending an e-mail to hello@hng.tech. Please include your name, your
            organization name, contact information (such as a phone number
            ...
            <div className="policy-term-of-use">
            <p>
                Approved organizations may hyperlink to our websiter as follows:
            </p>
            <ul className="policyUnordered">
                <li>By use of our corperate name</li>
                <li>By use of our corperate name</li>
                <li>By use of our corperate name</li>
            </ul>
            <p>
                No use of start.ng's logo or other artwork will be allowed for
        ...
        <div className="policy-right-resevation">
        ...
        <div className="policy-link-removal">
        ...
        <div className="policy-content-stability">
        ...
        <ul className="policyUnordered">
            ...
            <li>
            The materials on startNg's website are provided on an 'as is' basis.
            startNg makes no warranties, expressed or implied, and hereby
            ...
            <li>
            Further, startNg does not warrant or make any representations
